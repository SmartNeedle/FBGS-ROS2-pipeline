...
def generate_launch_description():
    ...
    node_benchmarker = Node(
        ...
        namespace='benchmark/needle',
        executable='shapesensing_benchmarker',
        output='screen',
        emulate_tty=True,
        parameters=[
            {
                "benchmarker.odir"                     : LaunchConfiguration(arg_odir.name),
                "benchmarker.insertion_depth.increment": LaunchConfiguration(arg_insdepthinc.name),
                "benchmarker.num_samples"              : LaunchConfiguration(arg_numsamples.name),
            }
        ]
